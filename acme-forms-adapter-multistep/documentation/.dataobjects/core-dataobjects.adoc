...
+++
|[[services]]`services`|`Array of link:cheatsheets.adoc#MultiStepFormsAdapterSettings[MultiStepFormsAdapterSettings]`|
+++
Sets the configuration of each service endpoint used by the adapter.
+++
|===
[[MultiStepFormsAdapterSettings]]
== MultiStepFormsAdapterSettings
