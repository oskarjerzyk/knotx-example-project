 ...
 */
package com.acme.databridge.adapter.redis.common.configuration;
...
public class RedisDataBridgeAdapterOptions {
  ...
  private List<RedisDataBridgeSettings> services;
  private CustomHttpHeader customHttpHeader;

  /**
   * Default constructor
   */
  public RedisDataBridgeAdapterOptions() {
    init();
  }
   ...
   */
  public RedisDataBridgeAdapterOptions(
      RedisDataBridgeAdapterOptions other) {
   ...
   * @param json the JSON
   */
  public RedisDataBridgeAdapterOptions(JsonObject json) {
    init();
    RedisDataBridgeAdapterOptionsConverter.fromJson(json, this);
  }
  ...
  public JsonObject toJson() {
    ...
    RedisDataBridgeAdapterOptionsConverter.toJson(this, json);
    return json;
  }
   ...
   */
  public RedisDataBridgeAdapterOptions setAddress(
      String address) {
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public RedisDataBridgeAdapterOptions setClientOptions(
  ...
  /**
   * @return a list of {@link RedisDataBridgeSettings} describing all service endpoints the ServiceAdapter
   * need to communicate
   */
  public List<RedisDataBridgeSettings> getServices() {
    return services;
  }
   ...
   *
   * @param services the {@link RedisDataBridgeSettings} objects representing each service endpoint
   * @return a reference to this, so the API can be used fluently
   */
  public RedisDataBridgeAdapterOptions setServices(
      List<RedisDataBridgeSettings> services) {
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public RedisDataBridgeAdapterOptions setCustomHttpHeader(
