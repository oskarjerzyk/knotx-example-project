...
public class RedisDataBridgeSettings {
   ...
   * Default constructor
   */
  public RedisDataBridgeSettings() {
    //empty constructor
  }
   ...
   * @param json the JSON
   */
  public RedisDataBridgeSettings(JsonObject json) {
    this();
    RedisDataBridgeSettingsConverter.fromJson(json, this);
  ...
  public JsonObject toJson() {
    ...
    RedisDataBridgeSettingsConverter.toJson(this, json);
    return json;
  }
  ...
  public RedisDataBridgeSettings setPath(String path) {
    this.path = path;
    return this;
  }
   ...
   */
  public RedisDataBridgeSettings setDomain(
      String domain) {
    this.domain = domain;
    return this;
  }
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public RedisDataBridgeSettings setPort(int port) {
    this.port = port;
    return this;
  }
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public RedisDataBridgeSettings setAllowedRequestHeaders(
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public RedisDataBridgeSettings setQueryParams(
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public RedisDataBridgeSettings setAdditionalHeaders(
  ...
  @GenIgnore
  public RedisDataBridgeSettings setAllowedRequestHeaderPatterns(
