...
import com.acme.databridge.adapter.redis.common.http.RedisClientFacade;
...
public class RedisDataBridgeAdapterProxyImpl extends AbstractFormsAdapterProxy {

  private RedisClientFacade httpClientFacade;

  public RedisDataBridgeAdapterProxyImpl(Vertx vertx, RedisDataBridgeAdapterOptions configuration) {
